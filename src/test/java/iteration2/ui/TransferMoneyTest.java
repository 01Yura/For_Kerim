...
//      TODO - тут аналогично с предыдущим тестом (по нескольким классам искать нельзя, "ul-li" тэгов нету там)
...
//              .click();
        $(Selectors.byXpath("//option[text()='-- Choose an account --']/ancestor::select")).selectOptionContainingText(accountSender.getAccountNumber());

//      TODO - имя можно не указывать
